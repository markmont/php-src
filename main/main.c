...
static PHP_INI_MH(OnUpdateErrorLog)
{
	...
	if ((stage == PHP_INI_STAGE_RUNTIME || stage == PHP_INI_STAGE_HTACCESS) && new_value && strcmp(new_value->val, "syslog") && strcmp(new_value->val, "journald")) {
